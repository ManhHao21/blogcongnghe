            ...
            <a href="{{route('post', $item->slug)}}">
                <div class="fh5co_suceefh5co_height"><img src="{{$item->imageUrl()}}" alt="img"/>
                    ...
                    <div class="fh5co_suceefh5co_height_position_absolute_font">
                        <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;{{\Carbon\Carbon::parse($item->create_at)->format('d-m-Y')}}
                        </a></div>
                        <div class=""><a href="single.html" class="fh5co_good_font">{{$item->title}}</a></div>
                    </div>
                </div>
            </a>
        </div>
                                ...
                                <div class="fh5co_suceefh5co_height_2">
                                    <a href="{{route('post', $item->slug)}}" class="fh5co_suceefh5co_height">
                                        ...
                                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                                            <div class=""><a href="{{route('post', $item->slug)}}" class="color_fff"> <i class="fa fa-clock-o"></i>{{\Carbon\Carbon::parse($item->create_at)->format('d-m-Y')}}</a></div>
