...
<body class="bg-gradient-primary">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="{{route('admin.check-login')}}" method="POST">
                                        @method('post')
                                        @csrf
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="{{route('admin.Auth.register')}}">Đăng kí tài khoản!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script src="{{asset('login-new/login-new/vendor/jquery/jquery.min.js')}}"></script>
